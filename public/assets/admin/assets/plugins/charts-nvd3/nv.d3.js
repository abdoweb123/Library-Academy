...
nv.models.discreteBar = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            var groups = wrap.select('.nv-groups').selectAll('.nv-groups')
            ...
            groups.exit()
                ...
                .remove();
            groups
                .attr('class', function(d,i) { return 'nv-groups nv-series-' + i })
                .classed('hover', function(d) { return d.hover });
            groups
...
nv.models.distroPlot = function() {
    ...
    // - when providing colorGroup, should color boxes by either parent or child groups category (e.g. isolator)
    ...
    function prepData(dat) {
        ...
        function calcStats(g, xGroup) {
            ...
            // make a new vertical scale for each groups
    ...
    /**
     * Given an x-axis groups, return the available color groups within it
     * provided that colorGroups is set, if not, x-axis groups is returned
     */
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            var areaEnter,
                distroplots = wrap.selectAll('.nv-distroplot-x-groups')
                    .data(function(d) { return d; });

            // rebind new data
            // we don't rebuild individual x-axis groups so that we can update transition them
            // however the data associated with each x-axis groups needs to be updated
            ...
            areaEnter = distroplots.enter()
                .append('g')
                .attr('class', 'nv-distroplot-x-groups')
            ...
            distroplots
                .watchTransition(renderWatch, 'nv-distroplot-x-groups: distroplots')
                .style('stroke-opacity', 1)
            ...
            distroplots.selectAll('line.nv-distroplot-middle')
                .watchTransition(renderWatch, 'nv-distroplot-x-groups: distroplots line')
            ...
            if (observationType == 'line') {
                distroplots.selectAll('g.nv-distroplot-observation line')
                  .watchTransition(renderWatch, 'nv-distrolot-x-groups: nv-distoplot-observation')
        ...
        renderWatch.renderEnd('nv-distroplot-x-groups immediate');
        return chart;
    }
    ...
    chart._options = Object.create({}, {
        ...
        colorGroup:       {get: function(){return colorGroup;}, set: function(_){colorGroup=_;}}, // data key to use to set color groups of each x-category - default: don't groups
...
nv.models.heatMapChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            // adjust position of axis based on presence of metadata groups
        ...
        selection.each(function(data) {
            ...
            groups
                .attr('class', function(d,i) {
                    return (d.classed || '') + ' nv-groups nv-series-' + i;
                })
                .classed('hover', function(d) { return d.hover })
...
nv.models.multiBar = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , color = nv.utils.defaultColor()
        , hideable = false
        , barColor = null // adding the ability to set the color for each rather than the whole groups
...
nv.models.multiBarHorizontal = function() {
    ...
    chart._options = Object.create({}, {
        ...
        stacked: {get: function(){return stacked;}, set: function(_){stacked=_;}},
        showValues: {get: function(){return showValues;}, set: function(_){showValues=_;}},
        // this shows the groups name, seems pointless?
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
           ...
           //Convert old data to new format (name, values)
            ...
            // Add a groups element for each dimension.
        ...
        selection.each(function(data) {
            ...
            function updateInteractiveLayer() {
                ...
                if (useVoronoi === true) {
                    ...
                    wrap.select('.nv-groups').selectAll('.nv-groups')
                        .selectAll('.nv-point')
                        //.data(dataWithPoints)
