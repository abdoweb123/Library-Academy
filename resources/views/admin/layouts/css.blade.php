<style>
    ...
    .slide.is-expanded .slide-menu li::before{
        display: none;
    }

    .slide.is-expanded .slide-menu .slide-item{
        margin-left: 8px;
    }

    table.dataTable tbody td, .table.table-bordered.text-nowrap thead th{
    ...
    .header.app-header .dropdown-menu.dropdown-menu-right {
        top: -7px !important;
    }
