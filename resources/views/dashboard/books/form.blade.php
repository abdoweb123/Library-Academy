                            ...
                            <div class="col-md-2 mt-3">
                                ...
                                <select name="location_id" id="location_id" class="form-control location-select">
                                    @if(isset($book))
                                        ...
                                        @if(isset($book) && $book_copies->first()->shelf)
                                        
                                            @php
                                                $shelf = $book_copies->first()->shelf;
                                            @endphp
                            ...
                            @if(isset($book) && $book->copies->count())
                                ...
                                <div class="row copy-item">
                                    <div class="copy-row row col-md-11 g-2">
                                        ...
                                        <x-form-input
                                            name="copies[{{ $i }}][shelf_order]"
                                            label="shelf_order"
                                            :value="$copy->shelf_order"
                                            :cols="'col-md'"
                                        />
                            ...
                            @else
                                ...
                                <div class="row copy-item">
                                    <div class="copy-row row col-md-11 g-2">
                                        ...
                                        <x-form-input name="copies[0][shelf_order]" label="shelf_order" :cols="'col-md'" />
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.location-select').select2({
                placeholder: "{{ trns('select_location') }}",
                ajax: {
                    url: "{{ route('dashboard.locations.search') }}",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
                        return {
